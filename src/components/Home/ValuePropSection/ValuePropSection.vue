<template>
    <div class="value-prop-section">
        <div class="value-prop-section__content">
            <div class="value-prop-section__content--left">
                <div class="value-prop">
                    <div class="value-prop__title">
                ...
                <div class="value-prop">
                    ...
                    <div class="value-prop__text">
                        When a system calls for it, I have achieved high scalability through Event Sourcing, actor model, CQRS and Domain Driven Design to ensure scalable operations and business continuity.
                    </div>
                </div>
            </div>
